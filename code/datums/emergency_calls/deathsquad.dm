...
/datum/emergency_call/deathsquad/print_backstory(mob/living/carbon/human/H)
	...
	to_chat(H, "")
	to_chat(H, "<B>Today, you and your squadmates are sent by Weyland-Yutani to the TGMC vessel, [SSmapping.configs[SHIP_MAP].map_name], after a long period of [pick("cryostasis", "rest and relaxation")].</b>")
