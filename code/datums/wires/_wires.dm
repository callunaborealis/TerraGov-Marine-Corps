...
/datum/wires
	...
	var/proper_name = "Unknown" // The display name for the wire set shown in station blueprints. Not used if randomize is true or it's an item W-Y wouldn't know about (Explosives/Nuke)
