...
/mob/new_player/proc/new_player_panel()
	...
	output += "<br><i>You are part of the <b>United States Colonial Marines</b>, the offical extrasolar armed forces of the United States.</i>"
	output +="<hr>"
	...
	var/datum/browser/popup = new(src, "playersetup", "<div align='center'>Welcome to USCM[SSmapping?.configs ? " - [SSmapping.configs[SHIP_MAP].map_name]" : ""]</div>", 300, 375)
...
/mob/new_player/proc/ViewLore()
	var/output = "<div align='center'>"
	output += "<a href='byond://?src=[REF(src)];lobby_choice=marines'>United States Colonial Marines</A><br><br><a href='byond://?src=[REF(src)];lobby_choice=aliens'>Xenomorph Hive</A>"
	output += "</div>"
