...
/obj/item/weapon/gun/flamer/marinestandard
	...
	desc = "The TL-84 flamethrower is the current standard issue flamethrower of the USCM, and is used for area control and urban combat. Uses large flamethrower cans to fuel itself."
