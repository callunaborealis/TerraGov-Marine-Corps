...
/obj/machinery/marine_selector/clothes/synth
	...
	listed_products = list(
		...
		/obj/item/clothing/under/marine = list(CAT_STD, "USCM marine uniform", 0, "black"),
		...
		/obj/item/clothing/under/whites = list(CAT_STD, "USCM dress uniform", 0, "black"),
		...
		/obj/item/storage/backpack/marine/corpsman = list(CAT_BAK, "USCM corpsman backpack", 0, "black"),
		/obj/item/storage/backpack/marine/tech = list(CAT_BAK, "USCM technician backpack", 0, "black"),
		/obj/item/storage/backpack/marine/engineerpack = list(CAT_BAK, "USCM technician welderpack", 0, "black"),
		...
		/obj/item/clothing/head/tgmccap = list(CAT_HEL, "USCM cap", 0, "black"),
